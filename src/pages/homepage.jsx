  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        {/* Header */}
        <header className="fixed w-full bg-black/40 backdrop-blur-sm z-50">
          ...
          <footer className="bg-black/90 py-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#booking" className="text-gray-300 hover:text-red-600 transition-colors">Book Service</a>
                </li>
                <li>
